  ...
  <div class="prism-editor-wrapper">
    ...
    >
      ...
      <div
        ...
        :id="`${objectName}__line${line}`"
        v-for="line in lineNumbersCount"
        :key="line"
        @click="clickLineNumber(line)"
      >
        {{ line }}
      </div>
    </div>
...
<script>
import prism from '../../lib/editor/prism'
import escapeHtml from 'escape-html'
import normalizeHtml from '../../lib/editor/normalizeHtml.js'
import htmlToPlain from '../../lib/editor/htmlToPlain.js'
import selectionRange from '../../lib/editor/selection-range.js'
import { getIndent, getDeindentLevel } from '../../lib/editor/getIndent'
import { FORBIDDEN_KEYS } from '../../lib/editor/constant'
...
export default {
  ...
  methods: {
    clickLineNumber (lineNumber) {
      if (this.lineNumbersClickEvent) {
        let plainText = this.getPlain()
        this.lineNumbersClickEvent(lineNumber, plainText.split('\n')[lineNumber - 1])
      }
    },
